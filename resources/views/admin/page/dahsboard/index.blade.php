        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="mb-0 mt-2 text-success">
                    64.00%<span class="text-black ml-1"><small>(30 days)</small></span>
                </p>
            </div>
        </div>
    </div>
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="mb-0 mt-2 text-success">
                    23.00%<span class="text-black ml-1"><small>(30 days)</small></span>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="card border-bottom-0">
            <div class="card-body pb-0">
                ...
                <p class="text-muted font-weight-light">
                    ...
                    like this: If you use real content in the design process,
                    anytime you reach a review
                </p>
