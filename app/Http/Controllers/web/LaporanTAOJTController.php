...
class LaporanTAOJTController extends Controller
{

    public function title()
    {
        return 'Halaman Laporan TA & OJT';
    }
    public function subtitle()
    {
        return 'Add Laporan TA & OJT';
    }
    public function js()
    {
        // return asset('controller_js/admin/Laporan TA & OJT.js');
    }
    public function routeName()
    {
        return 'laporan/TA-OJT';
    }

    public function index()
    {
        $data['data'] = LaporanTaOjt::with('Angkatan')->get();
        // dd($data['data']);
        $data['subtitle'] = $this->subtitle();
        $data['routeName'] = $this->routeName();
        $konten = view('admin.page.research.laporan_ta_ojt.index', $data);
        $js = $this->js();

        $put['title'] = 'Halaman Laporan TA & OJT';
        $put['konten'] = $konten;
        $put['js'] = $js;
    ...
    public function create()
    {
        ...
        $data['routeName'] = $this->routeName();
        $konten = view('admin.page.research.laporan_ta_ojt.form', $data);
        $js = $this->js();
